...
#
#
# objects will retain their ids inside the block
# they will change when reassiged
# and stay changed after the block
#
#
#
#
...
# Question 2
#
# The method will not change the object ids of the outside method objects
# even when reassigned inside the method because the values are passed in
# and given
#
#
#
...
#
# a_string_param is not returned by tricky_method so my_string is not changed
#
...
#
#
# gsub! modifies the caller
# the = Array assignment operator creates a new object
#

def tricky_method_two(a_string_param, an_array_param)
  a_string_param.gsub!('pumpkins', 'rutabaga2')
